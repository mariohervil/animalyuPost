...
void main() {
  runApp(DevProfileDesign());
}

class DevProfileDesign extends StatefulWidget {
  const DevProfileDesign({Key? key}) : super(key: key);

  @override
  State<DevProfileDesign> createState() => _DevProfileDesignState();
}

class _DevProfileDesignState extends State<DevProfileDesign> {
  ...
  Widget build(BuildContext context) {
    ...
    String name = "Desarrolladores";
    String email = "animalyucorp@campus.monlau.com";
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          ...
          decoration:  BoxDecoration(
              image: DecorationImage(
                  image: new AssetImage("assets/noteBack.jpg"), fit: BoxFit.fill),
              boxShadow: [
                BoxShadow(
                  color: Colors.white,
                  blurRadius: 0,
